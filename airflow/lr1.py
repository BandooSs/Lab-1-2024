...
parent_directory_input = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'data', 'LR_1', 'input')  
parent_directory_output = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'data', 'LR_1', 'output')  
