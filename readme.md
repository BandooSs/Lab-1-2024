...
Пришлось долго помучиться с MergeRecord. Не хотелось удалять дубликаты полей из-за использования MergeContent.
...
## Трудности
Очень долго вникал, т.к. никогда с этим не работал. Возникли большие пробелемы с объединением строк в Nifi. В Airflow было намного легче.
